...
export default function WelcomeBanner({ onClose, isVisible }: WelcomeBannerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] h-dvh overflow-hidden bg-[#0f0c08]">
      ...
      />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,196,87,0.18),transparent_35%),radial-gradient(circle_at_bottom,rgba(255,143,36,0.14),transparent_28%)]" />
      ...
      <div className="relative flex h-full items-center justify-center px-4 py-4 sm:px-6">
        <div className="relative w-full max-w-[440px] text-center">
          <div className="mx-auto mb-0 h-20 w-px bg-gradient-to-b from-transparent via-[#f6d08a] to-[#f6d08a]" />
          <div className="mx-auto mb-[-10px] h-4 w-4 rounded-full border border-[#ffe1a6] bg-[#fff5db] shadow-[0_0_18px_rgba(255,209,102,0.55)]" />
          ...
          <div className="relative max-h-[calc(100dvh-2rem)] overflow-hidden rounded-[28px] border border-white/10 bg-[#12100d]/95 px-6 py-7 text-white shadow-[0_25px_80px_rgba(0,0,0,0.55)] sm:px-8 sm:py-8">
            ...
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#ffb84d]/25 bg-[#ffb84d]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-[#ffd58a]">
              Opening Soon
            </div>

            <div className="space-y-2">
              <div className="text-4xl font-black tracking-[0.18em] text-[#ffae3d] sm:text-5xl">
                MR SANGA&apos;S
              </div>
            ...
            <div className="my-6 flex items-center justify-center gap-3 text-[#ffd58a]">
              <div className="h-px w-12 bg-gradient-to-r from-transparent to-[#ffd58a]/60" />
              <UtensilsCrossed className="h-5 w-5" />
              <div className="h-px w-12 bg-gradient-to-l from-transparent to-[#ffd58a]/60" />
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="text-5xl font-black leading-none tracking-[0.14em] text-[#ffb347] sm:text-6xl">
                Soon
              </div>
            </div>
            ...
            <div className="mt-6 space-y-3 rounded-2xl border border-white/8 bg-white/5 px-4 py-4 text-left text-sm text-white/80 sm:px-5">
              <div className="flex items-start gap-3">
                <Star className="mt-0.5 h-4 w-4 shrink-0 text-[#ffd58a]" />
                <p>Freshly prepared sandwiches and comfort food made for every craving.</p>
              </div>
              <div className="flex items-start gap-3">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-[#ffd58a]" />
                <p>Brisbane, Australia</p>
              </div>
              <div className="flex items-start gap-3">
             <button
                onClick={onClose}
                className="inline-flex items-center justify-center rounded-full text-sm text-[#ffb347] text-center transition"
              >
                Continue to Site
              </button>
              </div>
