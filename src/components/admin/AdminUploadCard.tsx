  ...
  return (
    <div className="rounded-[2rem] border border-red-300/20 bg-[#070707]/95 p-4 shadow-[0_24px_80px_-50px_rgba(218,41,28,0.35)] sm:p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.35em] text-red-300/70">Photo upload</p>
          <h2 className="mt-3 text-2xl font-semibold text-white">Add a new image</h2>
        </div>
        <div className="rounded-full border border-red-300/20 bg-red-300/10 px-4 py-2 text-sm text-red-200">
          Ready to upload
        </div>
      </div>
      <form onSubmit={onSubmit} className="mt-8 grid gap-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="inline-flex items-center justify-center rounded-full bg-red-400 px-6 py-3 text-sm font-semibold text-black transition hover:bg-red-300 disabled:cursor-not-allowed disabled:opacity-50"
        >
